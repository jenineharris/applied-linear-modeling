...
* Use mutate with *recode_factor* to recode zombie so that zombie = 1 and not zombie = 0, check with the table function to make sure it worked! (recode_factor works like recode for when your variable is a factor data type)
